...
func renderPlayerTCPConfig() string {
	return `# Reference copy. roost add transport tcp automatically adds this
...
`, generatedHeader, manifest.Project.Module+"/internal/access/player", manifest.Project.Module+"/game/player_agent")
}
