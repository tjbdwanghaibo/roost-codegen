...
// transportTemplate renders the whole transport for one service.
//
...
var transportTemplate = template.Must(template.New("transport").Funcs(template.FuncMap{
	"json":       jsonName,
	"exportName": exportName,
}).Parse(`// Code generated by roost servicerpc. DO NOT EDIT.
//
